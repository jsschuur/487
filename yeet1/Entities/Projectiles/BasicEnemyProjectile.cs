...
{
    class BasicEnemyProjectile : Entity
    {
        private const int _spriteWidth = 16;
        private const int _spriteHeight = 16;

        private const int _destinationWidth = 16;
        private const int _destinationHeight = 16;

        private const string _textureName = "BasicEnemyProjectile";

        public BasicEnemyProjectile(Texture2D texture, Vector2 origin) : base(texture, origin)
        {
            _texture = texture;
