            ...
            if(e.Type == "projectile")
            {
                switch(e.Origin)
                {
                    case Static.Origin.TopCenter:
                        ...
                        Utility.OriginMath.TopCenter(creator.DestinationRectangle, new Rectangle(0, 0, e.projectileInformation.Width, e.projectileInformation.Height)),
                        e.projectileInformation));
                        break;
                    case Static.Origin.BottomCenter:
                        AddEntity(new Projectile(_textureManager.LoadTexture(e.projectileInformation.TextureName),
                        Utility.OriginMath.BottomCenter(creator.DestinationRectangle, new Rectangle(0, 0, e.projectileInformation.Width, e.projectileInformation.Height)),
                        e.projectileInformation));
                        break;
                    case Static.Origin.RightCenter:
                        AddEntity(new Projectile(_textureManager.LoadTexture(e.projectileInformation.TextureName),
                        Utility.OriginMath.RightCenter(creator.DestinationRectangle, new Rectangle(0, 0, e.projectileInformation.Width, e.projectileInformation.Height)),
                        e.projectileInformation));
                        break;
                    case Static.Origin.LeftCenter:
                        AddEntity(new Projectile(_textureManager.LoadTexture(e.projectileInformation.TextureName),
                        Utility.OriginMath.LeftCenter(creator.DestinationRectangle, new Rectangle(0, 0, e.projectileInformation.Width, e.projectileInformation.Height)),
                        e.projectileInformation));
                        break;
                }
            }
