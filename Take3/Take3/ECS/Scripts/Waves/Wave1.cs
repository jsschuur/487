    ...
    class Wave1 : Wave
    {
        public override void Initialize(GameObject owner)
        {
            ...
            var spawnArray = new[]
            {
                ...
                //testy
                new Spawn("RedCircle", new Vector2(330, 125), 0),
                //new Spawn("BlackCircle", new Vector2(330, 50), 0),
                //new Spawn("GreenSquare", new Vector2(130, 100), 0),
                //new Spawn("BlueDiamond", new Vector2(330, 150), 0),
                //new Spawn("YellowHexagon", new Vector2(330, 60), 0),
